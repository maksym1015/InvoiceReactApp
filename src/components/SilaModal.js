...
export default function SilaModal({ show, setShow }) {
  ...
  return (
    <>
      ...
      {show && (
        <div className="sila-modal feeds-modal register">
          {loading && <Loader />}
          ...
          <div className="">
            <ul className="connecting-dots mt-5">
            ...
            <form onSubmit={onSubmit} className="p-5 mt-4">
                  ...
                  <div className="form-group">
                    ...
                    <p className="text-right">
                      <small className="extra-small">
                        This is not the business address, but your personal
                        address.
                      </small>
                    </p>
                  </div>
              ...
              {step === 5 && (
                <div className="form-group">
                  ...
                  <p className="text-right">
                    <small className="extra-small">
                      This is used to verify your identity in compliance with
                      KYC standards.
                    </small>
                  </p>
                </div>
