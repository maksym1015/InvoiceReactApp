...
export default function OnlineSessionInvoice(props) {
    ...
    return (
        <div className="invoice-card shadow fitness">
            ...
            <h3 className="text-center font-weight-bold mb-0">Online Session</h3>
        </div>
    );
}
