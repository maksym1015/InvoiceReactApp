...
export default function Consulting(props) {
    ...
    return (
        <div className="invoice-card shadow professional">
                ...
                <table className="table table-sm mb-0">
                    ...
                    <tbody>
                        {props.items.map((item, index) => (
                            <tr key={index}>
                                <td>{item.title}<br /><span className="text-secondary">{item.description}</span></td>
                    ...
                    {/* <tfoot>
                        <tr>
                            <td colSpan="4" className="text-right">
                                Amount Due <span className="font-weight-bold ml-5">${total(props.items)}</span>
                            </td>
                        </tr>
                    </tfoot> */}
                </table>
            ...
            <h3 className="text-center font-weight-bold mb-0">Consulting</h3>
        </div>
    );
}
