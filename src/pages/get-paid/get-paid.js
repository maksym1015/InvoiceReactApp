...
export default function Pay() {
  ...
  let noInvoicesSchedule = (
    <div className="no-invoice-placeholder">
      ...
      <img src="/images/NEW_dream_money.svg" alt="No invoices" width="100%" />
  ...
  let noInvoicesPaid = (
    <div className="no-invoice-placeholder">
      <img src="/images/People_search3.svg" alt="No invoices" width="100%" />
    </div>
  );

  const getInvoices = () => {
    api
      .get("invoices?type=outgoing")
      .then((response) => {
  ...
  return (
    <div className="home get-paid robinhood">
      <Menu selected={isPaid} setSelected={setIsPaid} title="Get Paid" />
                ...
                {invoice.id ? (
                  <div className="home-view-invoice invoice-details position-relative">
                    ...
                    <small className="extra-small">
                      ...
                      <div className="row mt-3 mt-xl-5">
                        <div className="w-100">
                          <button className="btn get-paid__invoice--outline-button mb-3 d-flex align-items-center justify-content-between">
                        ...
                        <div className="w-100">
                          <button className="btn btn-custom mb-3 textLBold__font-size get-paid__invoice--primary-button" disabled={invoice.status === 'paid'}>
                            <span>Pay</span>
                            <span className="float-right">$2650</span>
                          </button>
                        </div>
                      </div>
                    </div> */}
